...
import Img from '../assets/calculadora.png';
      ...
      <div className='container mx-auto'>
        <div className='flex flex-col lg:flex-row gap-x-10'>
          ...
          className='flex-1 flex flex-col mb-8 lg:mb-0'>
            ...
            <div className='together group relative overflow-hidden border-2 border-white/50 rounded-xl'>
          ...
          <div className='together group relative overflow-hidden border-2 
            ...
            <div className='together group relative overflow-hidden border-2 border-white/50 rounded-xl'>
              ...
              <div className='absolute -bottom-full left-12 group-hover:bottom-24 
              transition-all duration-500 z-50'>
                <a href='https://clon-landin-page.vercel.app/'><span className='text-2xl text-gradient'>Landing Page Clon</span></a>
              </div>
              <div className='absolute -bottom-full left-12 group-hover:bottom-14 
              transition-all duration-700 z-50'>
